					...
					<table class="table table-bordered table-striped">
						...
						<thead class="text-center">
							<tr class="text-center">
								...
								<th><p class="text-center">Цена за блюдо</p></th>
								<th><p class="text-center">Кол-во возможных к быстрому приготовлению блюд</p></th>
						...
						<tbody>
							...
							<c:forEach var="meal" items="${meals}">
								<tr>
									...
									<td><p class="text-left"><a href="../viewmeal?id=${meal.id}">${meal.title}</a></p></td>
